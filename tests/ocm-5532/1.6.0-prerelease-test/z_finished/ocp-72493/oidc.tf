...
resource "rhcs_rosa_oidc_config" "oidc_config" {
  ...
  installer_role_arn = "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role${local.account_role_path}${local.account_role_prefix}-HCP-ROSA-Installer-Role"
}
...
module "operator_iam_role" {
  ...
  role_path                     = local.account_role_path
